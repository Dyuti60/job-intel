...
Extend **CMS_DETAIL** with explicit source-owned link aliases and bounded listing/detail/document
rules. Existing Agriculture and NHM candidate configurations are not activation evidence.
